...
const clientEntrypoints = [
  ...
  {
    name: 'CLIENT - New Estimate Dialog',
    entry: './src/client/dialog-new-estimate/index.js',
    filename: 'dialog-new-estimate',
    template: './src/client/dialog-new-estimate/index.html',
  }
];
